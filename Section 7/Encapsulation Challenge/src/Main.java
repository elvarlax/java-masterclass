...
and also whether tis a duplex printer (capable of printing on both sides of the paper).
Add methods to fill up the toner (up to maximum of 100%), another methods to
